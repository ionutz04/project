...
const BUFFER_SIZE: usize = 2048; // Mărește pentru a captura ≥1 ciclu
...
async fn main(_spawner: Spawner) {
    ...
    let mut adc_channel = Channel::new_pin(peripherals.PIN_26, Pull::None);
    ...
    loop {
        ...
        if index == 0 {
            ...
            let amplitude = (max as f32) * 3.3 / 4095.0;
            info!(
                "ADC Value: {} | FWHM: {} μs | Freq: {} Hz | Amp: {} V | Time: {} s",
                value,
                fwhm,
                frequency * 1000.0,
                amplitude,
